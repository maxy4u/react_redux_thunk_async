...
class App extends Component {
	...
	render(){
		let ticketList = this.props.tickets.map((ticket)=>( <TicketItem key={ticket.id} ticket={ticket} />));		
	return (
			<div>
				<header>
...
const mapDispatchToProps = (dispatch)=>(
	{
		...
		fetchTickets:(origin,destination)=>{debugger;dispatch(AirportActionCreators.fetchTickets(origin,destination))}
